    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '65f8bb52-e831-46fb-bbec-80af4f4e00b3',
                    name: data.name || '',
                    email: data.email || '',
...
document.addEventListener('DOMContentLoaded', function() {
  const ctaButton = document.querySelector('.hero-pickwig .cta-button');
  ...
  const heroImage = document.querySelector('.hero-pickwig .hero-image');
...
/* Added Component Script */
// Optional: Add smooth scroll reveal animation when section comes into view
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Add click-to-enlarge functionality for logo
  const mainLogo = document.querySelector('.main-logo');
  if (mainLogo) {
    mainLogo.addEventListener('click', function(e) {
      // Only trigger if not in edit mode (no data-zappy-editable-image active state)
      if (!this.closest('[data-zappy-editing]')) {
...
/* Added Component Script */
// Optional: Add smooth scroll behavior for CTA button if it links to a contact form
document.addEventListener('DOMContentLoaded', function() {
  const ctaButton = document.querySelector('.premium-cta');
  
  if (ctaButton) {
    // Add click tracking or smooth scroll functionality
    ctaButton.addEventListener('click', function(e) {
      ...
      if (typeof gtag !== 'undefined') {
        gtag('event', 'click', {
          'event_category': 'CTA',
          'event_label': 'Premium Section Consultation'
        });
      }
    });
  }
  ...
  const premiumSection = document.querySelector('.pickwig-premium-section');
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '65f8bb52-e831-46fb-bbec-80af4f4e00b3';
